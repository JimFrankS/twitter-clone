...
import notificationRoutes from "./routes/notification.route.js"; // Import the notification routes
...
app.use("/api/notifications", notificationRoutes); // Use the notification routes for the /api/notifications endpoint
